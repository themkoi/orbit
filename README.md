...
```toml
position = "top-right"
# transition type possible options are: "slideright", "slideleft", "slideup", "slidedown", "swingright", "swingleft", "swingup", "swingdown", "fade", 
window_transition = "slidedown" "crossfade", "none"
